...
const RegisterPage: React.FC = () => {
  ...
  const { registerUser, supabaseConfigured, loginWithProvider } = useAuth();
      ...
      <div className="w-full max-w-md">
        <div className="bg-[var(--surface-primary)] rounded-2xl border border-[var(--border-light)] p-8 shadow-[var(--shadow-float)]">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[var(--text-strong)]">Create Account</h1>
            <p className="text-[var(--text-muted)] mt-2">Start securing your applications with VulScan</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-[10px] font-bold uppercase tracking-wider text-[var(--text-strong)] mb-1">
                Full Name (optional)
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[10px] font-bold uppercase tracking-wider text-[var(--text-strong)] mb-1">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-[var(--text-muted)]" />
